$(function () {
    var $menu = $(".menu"), $menuLi = $menu.find("li"), $current = $menu.find('.current'), $li3 = $menu.find('li.li_3'), $li3Content = $li3.find('.li_3_content');
    ...
    $li3.hover(function () {
        $li3Content.stop(true, true).fadeIn(0);
    }, function () {
        $li3Content.fadeOut(500, function () {
            $li3Content.css("display", "none");
        });
    });

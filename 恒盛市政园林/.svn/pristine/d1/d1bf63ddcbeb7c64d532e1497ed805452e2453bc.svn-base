    ...
    $.fn.lrkf = function (options) {
        ...
        function init() {
            ...
            if (!opts.diyCon) {
                ...
                if (opts.qrCode) {
                    $kfList.append("<li class=hr></li><li class=qrcode><span>微信关注:</span><br/><img src='" + opts.qrCode + "'/></li>");
                }
                if (opts.more) {
...
$(function () {
    $("#lrkfwarp").lrkf({
        ...
        defShow: false,
        qqs: [
                { 'name': '筑星客服', 'qq': '3323152338' }
            ],
        tel: [
                { 'name': '服务电话', 'tel': '0755-86240165' }, 	//注意逗号是英文的逗号
            ],
        qrCode: '../../Content/images/footer/footer_weixin_record.png', //二维码的路径，自行修改
        foot: "9:00-18:00"                                  //底部在线时间，有些风格里面没有给这个预留位置

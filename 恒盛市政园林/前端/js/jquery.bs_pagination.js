...
(function($) {
    ...
    var methods = {
        ...
        init: function(options) {
            ...
            return this.each(function() {
				...
				rsc_bs_pag = settings.rsc_bs_pag;
        ...
        getDefaults: function(bootstrap_version) {
            ...
            if(bootstrap_version == "2") {
                ...
                default_settings.navListWrapperClass = "pagination_custom";
    ...
    var change_page = function(container_id, previous_selection, current_selection, update_nav_items, trigger_change_page) {
		...
		if(s.showRowsInfo && !s.showRowsDefaultInfo && s.showCurrentAndTotalInfo){
			var info_id = create_id(s.nav_rows_info_id_prefix, container_id);
            $("#" + info_id).html(s.currentPage+" / "+s.totalPages);
		}
